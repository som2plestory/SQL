-- 문제1.
-- 매니저가 있는 직원은 몇 명입니까? (haveMngCnt - 106명)
select count(first_name) "haveMngCnt"
from employees
...
-- 문제3.
-- 마지막으로 신입사원이 들어온 날은 언제입니까? 다음 형식으로 출력해주세요.
-- 예) 2014년 07월 10일
...
-- 문제9.
-- 2005년 이후 입사자 중 관리자별로 평균급여 최소급여 최대급여를 알아보려고 한다.
...
-- 입사일이 02/12/31 이전이면 '창립멤버, 03년은 '03년입사', 04년은 '04년입사'
